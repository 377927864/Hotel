<%@ page import="cn.hotel.service.HotelService" %>
<%@ page import="cn.hotel.service.impl.HotelServiceImpl" %>
...
*/
            /*alert(lng+"+++"+lat);*/
        <%
            Double lng = 121.525221;
            Double lat = 31.217139;

            HotelService service = new HotelServiceImpl();
            List<Hotel> list = service.SearchAsPlace(lng, lat);
            List<Hotel> recList = list.subList(0,5);
            request.setAttribute("_hotel", recList);
        %>

            /*alert("+++");
            //刚加载此界面时，从后台查询出最符合该用户的5个酒店返回到本页
            $.ajax({
                type:"POST",
                <%--url:"${pageContext.request.contextPath}/RecServlet",--%>
                data:{
                    lng:121.525221,
                    lat:31.217139
                },
                success:function (json) {
                    alert(json);    //弹出返回过来的List对象
                    alert("成功！！！");
                }
            });*/
        };
        ...
        function typecase() {
            ...
            // alert(selectedvalue);
                if (selectedvalue=="关键字"){
                    <%--document.form1.action="${pageCont?ext.request.contextPath}/SearchServlet?a=1";--%>
        ...
        <%--function dimensions() {--%>
            ...
            <%--for(var i = 1; i < 6; i++){--%>
                <%--var a = document.getElementById("selection_box_"+i);--%>
                <%--arr.add(a);--%>
            <%--}--%>
            <%--var selectedvalue = $(":selected","#searchtype").attr("value");--%>
            <%--// alert(selectedvalue);--%>
            <%--if (selectedvalue=="关键字"){--%>
                <%--b = 1;--%>
                <%--document.form1.action="${pageContext.request.contextPath}/DimensionsServlet?b=1?a="+arr;--%>
                <%--document.form1.submit();--%>
                <%--&lt;%&ndash;document.getElementById("form1").action="${pageContext.request.contextPath}/SearchServlet?a=1"&ndash;%&gt;--%>
            <%--}--%>
            <%--else{--%>
                <%--b = 2;--%>
                <%--document.form1.action="${pageContext.request.contextPath}/DimensionsServlet?b=2?a="+arr;--%>
                <%--document.form1.submit();--%>
                <%--&lt;%&ndash;document.getElementById("form1").action="${pageContext.request.contextPath}/SearchServlet?a=3"&ndash;%&gt;--%>
            <%--}--%>
        <%--}--%>
    ...
    <div class="bannerMiddleBox">
        ...
        <div class="bannerLeftBox">
            ...
            <div class="bannerList">
                <ul>
                    <li id="active"><a href="#"><div>酒店</div></a></li>
            ...
            <div class="hotContentBox">
                ...
                <div class="picContentBox">
                    ...
                    <div class="picSearch  width910">
                        <c:forEach items="${requestScope._hotel}" var="hotel">
                            <div class="_list">
            ...
            <div class="hotNavBox">
                <ul>
                    <li id="active">
                        <a href="#">
                            热门
                            <img src="./images/index/top3.png" alt="" class="top">
                        </a>
                    </li>
                    <li class="rePosition">
                        <a href="#">
                            特价旅游
                            <img src="./images/index/hot.png" alt="" class="hot">
                        </a>
                    </li>
                    <li><a href="#">出境游</a></li>
                    <li><a href="#">境内游</a></li>
                    ...
                    <li class="rePosition">
                        <a href="#">
                            当地玩乐
                            <img src="./images/index/new.png" alt=""  class="new">
                        </a>
                    </li>
                    <li><a href="#">境内游</a></li>
                    <li><a href="#">境内游</a></li>
                ...
                <div class="rightOut">
                    南宁出发
                    <img src="./images/index/bottom3.png" alt="">
                </div>
            </div>
            <!-- 热门的内容区 -->
            <div class="hotContentBox">
                ...
                <div class="picContentBox">
                    ...
                    <div class="picLeft  width910">
                        ...
                        <div class="imgBox rePosition">
                            <a href="#">
                                ...
                                <img src="./images/index/pic.1.jpg" alt="">
                            </a>
                        </div>
                        <!-- 当个盒子结束 -->
                        <div class="imgBox rePosition">
                    ...
                    <!-- 右侧图片盒子
                    <div class="picRight">
                        <img src="./images/index/pic.9.jpg" alt="">
                    </div>-->
                </div>
                ...
                <div class="picContentBox">
                    ...
                    <div class="newsBox">
                        ...
                        <ul>
                            ...
                            <li><a href="#">睡遍全世界—新加坡国家馆</a></li>
                            <li><a href="#">睡遍全世界—新加坡国家馆睡遍全世界—新加坡国家馆</a></li>
                            <li><a href="#">睡遍全世界—新加坡</a></li>
                            <li><a href="#">睡遍全世界—新加坡国家馆</a></li>
                        </ul>
                        <h4 class="h4">发现酒店</h4>
                        <ul>
                    ...
                    <div class="rightBox">
                        <!-- 精选列表 -->
                        <div class="navListBox bottom10">
                            <ul>
                                <li id="active"><a href="#">热门城市</a></li>
                                <li><a href="#">都市购物</a></li>
                                <li><a href="#">都市购物</a></li>
                                <li><a href="#">都市购物</a></li>
                            </ul>
                        ...
                        <div class="picLeft width680">
                            ...
                            <div class="imgBox rePosition">
                                <a href="#">
                                    ...
                                    <img src="./images/index/div2.1.jpg" alt="">
                                </a>
                            </div>
                            <!-- 当个盒子结束 -->
                            <div class="imgBox rePosition">
