    ...
    <div class="topCenterBox">
        ...
        <div class="topRightBox">
            <ul>
                ...
                <li><a href="${pageContext.request.contextPath}/regist.jsp" target="_blank">免费注册</a></li>
                <li><a href="#" target="_blank">
                    <img src="./images/index/icon/message.png" class="message" alt="消息">
                    消息
                </a></li>
                <li><a href="#" target="_blank">我的酒店</a></li>
                ...
                <div class="hotContentBox">
                    ...
                    <div class="picContentBox">
                        ...
                        <div class="picSearch  width910">
                            <c:forEach items="${requestScope._dim_hotel}" var="hotel">
                                <div class="_list">
